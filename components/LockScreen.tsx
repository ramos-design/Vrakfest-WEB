    ...
    <div className="relative min-h-screen flex flex-col bg-[#0a0a0a]">
      ...
      <section className="relative flex-1 flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-30 text-center flex flex-col items-center">
          ...
          />
          <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bebas font-bold leading-[0.9] mb-12 animate-fadeIn uppercase tracking-tighter flex flex-col items-center gap-2 text-center">
            <span className="text-white">NOVÁ KAPITOLA PŘICHÁZÍ.</span>
            <span className="text-[#F4CE14] drop-shadow-[0_0_50px_rgba(244,206,20,0.8)]">BUĎTE U TOHO S NÁMI!</span>
          </h1>
